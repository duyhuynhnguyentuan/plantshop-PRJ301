...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
                                    ...
                                    <c:forEach items="${user}" var="u">
                                        <tr>
                                            ...
                                            <td><button class="btn btn-primary btn-sm edit" type="button" title="Sửa" id="show-emp" data-toggle="modal"
                                                ...
                                                <button class="btn btn-danger btn-sm delete" type="button" title="Xóa" id="show-emp" data-toggle="modal"
                                                        data-target="#ModalDEL${u.user_id}">
        ...
        <c:forEach items="${user}" var="u">           
            ...
            <!-- Delete modal window -->
            <div class="modal fade" id="ModalDEL${u.user_id}" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static"
                 data-keyboard="false">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
