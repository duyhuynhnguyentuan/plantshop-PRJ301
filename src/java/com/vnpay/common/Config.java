...
public class Config {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/PlantShop/home";
    public static String vnp_TmnCode = "UDE9ETWQ";
    public static String vnp_HashSecret = "NADXNAFQVPKXMTMAPUPAFUOWEFNZUDRK";
